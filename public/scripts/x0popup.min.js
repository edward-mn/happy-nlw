...
(x0popup = x0p = function () {
  ...
  function e() {
    ...
    switch (((t += '<div class="icon-wrapper">'), e)) {
      case "ok":
        t +=
          '<i class="xi xi-ok"><span class="xi-ok-left"></span><span class="xi-ok-right"></span></i>';
        break;
      case "error":
        t +=
          '<i class="xi xi-error"><span class="xi-error-left"></span><span class="xi-error-right"></span></i>';
        break;
      case "info":
        t +=
          '<i class="xi xi-info"><span class="xi-info-circle"></span><span class="xi-info-line"></span></i>';
        break;
      case "warning":
        t +=
          '<i class="xi xi-warning"><span class="xi-warning-circle"></span><span class="xi-warning-line"></span></i>';
        break;
      case "custom":
        t +=
          '<i class="xi" style="background: url(\'' +
          y.iconURL +
          "') no-repeat center center; background-size: 100% 100%;\"></i>";
    }
    return (t += "</div>");
  }
  function n() {
    ...
    if (
      ...
      null == x &&
        ((x = []),
        (1 != y.showCancelButton &&
          (0 == y.showCancelButton ||
            ("warning" != y.type && "input" != y.type))) ||
          x.push({ type: "cancel", key: 27 }),
        "text" == y.type || "input" == y.type
          ? x.push({ type: "info", key: 13 })
          : x.push({ type: y.type, key: 13 })),
      0 == x.length)
    )
      return "";
    var e = 1 == y.keyResponse ? "button" : "div",
      n = x.length,
      i =
        "width: " + (100 / n).toFixed(2) + "%; width: calc(100% / " + n + ");",
  ...
  function o() {
    ...
    t.innerHTML =
      '<div class="x0l"><div class="ball ball-4"></div><div class="ball ball-3"></div><div class="ball ball-2"></div><div class="ball ball-1"></div></div>';
  }
  function a() {
  ...
  function u(t) {
    for (var e = t.keyCode, n = 0; n < x.length; ++n)
      if (e == x[n].key) {
  ...
  function r(t, e) {
    ...
    if (null != n) {
      ...
      if ("cancel" != t && null != E && null != i) {
        if (null != y.inputPromise)
          return void y.inputPromise(t, i.value).then(function (n) {
            null != n ? p(n) : s(t, e);
          });
  ...
  function s(t, e) {
    ...
    clearTimeout(h), 1 == e ? o() : l();
    var i = null == n ? null : n.value;
    null != m && m(t, i, l), w({ button: t, text: i, close: l });
  }
  function p(t) {
    i("x0p-input-error");
    ...
    e.insertAdjacentHTML(
      "beforeend",
      '<div id="x0p-input-error" class="error">' + t + "</div>"
    );
  }
  function c(t) {
  ...
  function d() {
    ...
    return null == t
      ? ""
      : "<style>#x0p-input:focus { border-color:" +
          t +
          "; color:" +
          t +
          "; }</style>";
  ...
  function v(t) {
    ...
    return (e.innerText = e.textContent = t), (t = e.innerHTML);
  }
  var x,
    f = arguments[0],
    m = null,
    ...
    (y.title = arguments[0]),
      ...
      void 0 != arguments[3] &&
        ("boolean" == typeof arguments[3]
          ? (y.overlayAnimation = arguments[3])
          : (m = arguments[3]));
  else {
  ...
  var w,
    ...
    I = new Promise(function (n, i) {
      (w = n),
        ...
        y.overlay &&
          (C +=
            '<div id="x0p-overlay" class="x0p-overlay' +
            (y.animation && y.overlayAnimation ? "" : " no-animation") +
            '"></div>'),
        (C +=
          '<div id="x0popup" class="x0p ' +
          y.theme +
          (0 == y.animation ? " no-animation" : "") +
        ...
        (C += '<div class="content">'),
        (C += T
          ? '<div class="text-pure-wrapper">'
          : e() + '<div class="text-wrapper">'),
        (C += '<div class="text-anchor">'),
        (C += '<div class="title">' + y.title + "</div>"),
        null != y.text &&
          (C +=
            '<div class="text">' + (y.html ? y.text : v(y.text)) + "</div>"),
        null != E &&
          (C +=
            '<div id="x0p-input-anchor" class="input">' +
            d() +
            '<input id="x0p-input" type="' +
            E +
            '" placeholder="' +
            D +
            '" value="' +
